...
export default function HeroSection({ setShowPopup }) {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-4 h-full flex items-center">
        <div className="max-w-4xl">
          {/* Highlight banner (adjusted for mobile) */}
          <div className="mb-6 inline-flex items-center px-4 py-2 bg-white/90 rounded-full shadow-lg sm:ml-0 ml-2 sm:mx-0 mx-auto max-w-[95%]">
            <Award className="w-5 h-5 text-amber-600 mr-2" />
            <span className="text-sm font-medium text-gray-700">
              Pune's #1 Real Estate Brand - 6 Years Running
            </span>
          ...
          {/* Description box (smaller on mobile) */}
          <div className="bg-white/90 rounded-2xl p-4 md:p-6 mb-8 shadow-xl border border-white/50 text-sm md:text-lg">
            <p className="text-gray-600">
              A Majestic{' '}
              <span className="font-semibold text-amber-600">9-acre Estate</span> with
              <span className="font-semibold text-orange-600"> 4 acres of 'Larger than Life' Amenities</span> &
              Lush Greenery...{' '}
              <span className="font-bold text-gray-800">Yours for a lifetime.</span>
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <button
              onClick={() => setShowPopup(true)}
              className="group px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-violet-600 text-white rounded-xl font-semibold text-base sm:text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300"
            >
              <div className="flex items-center justify-center">
                <Download className="w-5 h-5 mr-2 group-hover:animate-bounce" />
                Download Brochure
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 sm:px-8 py-3 sm:py-4 bg-white/90 text-gray-800 rounded-xl font-semibold text-base sm:text-lg shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 border border-white/50 text-center flex items-center justify-center gap-2"
            >
              <img
                src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg"
                alt="WhatsApp"
